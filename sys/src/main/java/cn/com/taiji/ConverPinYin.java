...
//                System.out.println("ascii=" + ascii + "--asciiRang0="
//                        + asciiRang0 + "--asciiRang=" + asciiRang);
    ...
    public static String getFullSpell(String cnStr)
    {
        ...
        for (int i = 0, Len = chars.length; i < Len; i++)
        {
            ...
            System.out.println(chars[i] + "'s ascii=" + ascii);
            if (ascii == 0)
            { // 取ascii时出错
    ...
    {
        System.out.println(ConverPinYin.getFullSpell("哈哈"));
        // 输出结果为：haha
        System.out.println(ConverPinYin.getPinYin("哈哈"));
        // 输出结果为：hh
    }
}
